...
var tailwind_default = "/build/_assets/tailwind-SFXDJUFJ.css";
  ...
  return {
    ...
    verifyPasswordlessCode: async (email, code) => new Promise((resolve, reject) => {
      auth0Client.passwordlessLogin(
        ...
        function(err, res) {
          err ? reject(err) : (console.log(...oo_oo("1385112547_0", res)), resolve(res));
        }
      );
    })
  };
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(import_jsx_dev_runtime4.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("img", { src: "/svg/login.png" }, void 0, !1, {
...
function LoginForm() {
  let { env } = (0, import_react7.useLoaderData)(), { AUTH0_DOMAIN, AUTH0_CLIENT_ID, NODE_ENV } = env, auth0Config = {
    ...
    try {
      ...
      console.log(...oo_oo2("2790033281_0", "err: ", err));
    }
  }, handleGoogleLogin = () => {
    loginWithGoogle();
  };
  async function handleLoginPassword(e) {
    ...
    try {
      ...
      console.log(...oo_oo2("2790033281_1", res));
    } catch (err) {
      console.log(...oo_oo2("2790033281_2", "code verification error : ", err));
    }
  }
...
function Header() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(import_react10.Disclosure, { as: "nav", className: "bg-gray-800 header", children: ({ open }) => /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(import_jsx_dev_runtime5.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "mx-auto  px-2 sm:px-6 lg:px-8", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "relative flex h-16 items-center justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex flex-1 items-center  sm:items-stretch sm:justify-start", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex flex-shrink-0", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(import_react11.Link, { to: "/", className: "h-8 w-auto", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("h2", { className: "text-2xl font-bold leading-7 text-white sm:truncate sm:text-3xl sm:tracking-tight", children: "Pecha Tools" }, void 0, !1, {
...
var import_jsx_dev_runtime7 = require("react/jsx-dev-runtime"), loader2 = async ({ request, params }) => {
  ...
  let toolname = params.tool, toolList2 = await getCombineTools("spsither@gmail.com");
  if (toolList2.find((d) => d.name === toolname)) {
    let filtered = toolList2.filter((tool) => tool.name === toolname), url = filtered[0].url;
    return filtered[0].url.includes("session") || (url = filtered[0].url + "?session=" + user.email), {
      url,
      toolname,
      user
    };
...
function Dashboard() {
  let iframeRef = import_react16.default.useRef(null);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("div", { className: "h-[calc(100dvh-90px)] w-screen overflow-scroll", children: /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)(
    "iframe",
    {
...
function Main({ tools }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("main", { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("h1", { className: "text-xl font-bold", children: "Annotation Tools " }, void 0, !1, {
...
function Index() {
  ...
  return (0, import_react23.useEffect)(() => {
    socket && (user && (socket == null || socket.emit("user_login", user.email)), !user && socket.id && (socket == null || socket.emit("user_logout", socket.id)));
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("div", { className: "mx-auto max-w-7xl sm:px-6 lg:px-8", children: [
...
var assets_manifest_default = { entry: { module: "/build/entry.client-4YUXGF5F.js", imports: ["/build/_shared/chunk-ZWGWGGVF.js", "/build/_shared/chunk-GIAAE3CH.js", "/build/_shared/chunk-XU7DNSPJ.js", "/build/_shared/chunk-SYSHMECJ.js", "/build/_shared/chunk-7BQCVHR7.js", "/build/_shared/chunk-UWV35TSL.js", "/build/_shared/chunk-BOXFZXVX.js", "/build/_shared/chunk-PNG5AS42.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-3M4ACC7Y.js", imports: ["/build/_shared/chunk-QYFAPC3G.js"], hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !0 }, "routes/_index": { id: "routes/_index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/_index-MYQJNW7I.js", imports: ["/build/_shared/chunk-6JYTMWDU.js", "/build/_shared/chunk-G7CHZRZX.js", "/build/_shared/chunk-66RGZ5XA.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/api.user": { id: "routes/api.user", parentId: "root", path: "api/user", index: void 0, caseSensitive: void 0, module: "/build/routes/api.user-7BYWHH7L.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/callback": { id: "routes/callback", parentId: "root", path: "callback", index: void 0, caseSensitive: void 0, module: "/build/routes/callback-H7X24ZYG.js", imports: ["/build/_shared/chunk-G7CHZRZX.js", "/build/_shared/chunk-66RGZ5XA.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/dashboard": { id: "routes/dashboard", parentId: "root", path: "dashboard", index: void 0, caseSensitive: void 0, module: "/build/routes/dashboard-4ANI3ZZC.js", imports: ["/build/_shared/chunk-6JYTMWDU.js", "/build/_shared/chunk-66RGZ5XA.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/demo.$tool": { id: "routes/demo.$tool", parentId: "root", path: "demo/:tool", index: void 0, caseSensitive: void 0, module: "/build/routes/demo.$tool-SSZIYYNA.js", imports: ["/build/_shared/chunk-6JYTMWDU.js", "/build/_shared/chunk-66RGZ5XA.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/logout": { id: "routes/logout", parentId: "root", path: "logout", index: void 0, caseSensitive: void 0, module: "/build/routes/logout-GGSXPJWV.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/tool.$tool": { id: "routes/tool.$tool", parentId: "root", path: "tool/:tool", index: void 0, caseSensitive: void 0, module: "/build/routes/tool.$tool-7MJYC6BA.js", imports: ["/build/_shared/chunk-6JYTMWDU.js", "/build/_shared/chunk-G7CHZRZX.js", "/build/_shared/chunk-66RGZ5XA.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, version: "535bf617", hmr: { runtime: "/build/_shared\\chunk-7BQCVHR7.js", timestamp: 1695021121624 }, url: "/build/manifest-535BF617.js" };
